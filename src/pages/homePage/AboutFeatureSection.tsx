...
const AboutFeatureSection = () => {
  return (
    <>
      <div>
        <div className="grid gap-4 px-4  my-6 text-gray-800 md:grid-cols-2 xl:w-[1024px] 2xl:w-[1280px] xl:mx-auto items-center">
              ...
              <section className="grid gap-4 py-4">
                <div className="">
                  ...
                  <p className="">
                    ...
                    experienced team is dedicated to ensuring your oral health
          ...
          <section className="justify-self-center overflow-hidden">
            <AnimateToLeft>
              <img
                src={entranceImg}
